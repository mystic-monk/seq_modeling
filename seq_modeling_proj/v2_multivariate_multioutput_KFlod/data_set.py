...
class LineListingDataModule(L.LightningDataModule):
    ...
    def setup(self, stage=None):
        ...
        logger.info(f"Shapes -> X_train: {self.X_train.shape}, y_train: {self.y_train.shape}")
        logger.info(f"Shapes -> X_val: {self.X_val.shape}, y_val: {self.y_val.shape}")
        logger.info(f"Shapes -> X_test: {self.X_test.shape}, y_test: {self.y_test.shape}")
